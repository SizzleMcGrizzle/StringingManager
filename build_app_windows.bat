...
set JAVA_VERSION=17
set MAIN_JAR=stringingmanager-%PROJECT_VERSION%.jar
set NAME="StringingManager"
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\me\p3074098\stringingmanager\Application.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name %NAME% ^
  --main-class me.p3074098.stringingmanager.Application.class ^
  --main-jar %MAIN_JAR% ^
